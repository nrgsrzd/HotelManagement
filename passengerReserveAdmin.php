        ...
        <div class="container-fluid" style="margin-left:220px;">
            <div class="row">
                <div class="col-md-2 ps-0 mb-3">
                    ...
                    <input type="text" name="NID" value="<?= $_SESSION["pid"] ?>" class="form-control shadow-none" pattern="[0-9]{10}">
                </div>
                ...
                <div class="col-md-2 ps-0 mb-3">
                    ...
                    <input type="text" name="phone" class="form-control shadow-none" pattern="[0-9]{11}" required>
                </div>
                <div class="col-md-2 ps-0 mb-3">
           ...
           //     $passenger_id2 = selectp_id($qpa, "i");
            //    if($passenger_id2 !=0){
                //   $$passenger_id2="0"+$passenger_id2;
                    $qi = "INSERT INTO `reserve`(`passenger_id`, `start`, `end`, `payment`, `status`) VALUES ('$passenger_id2','$_SESSION[checkInDate]','$_SESSION[checkOutDate]','$_SESSION[price]','0')";
            ...
            if($oldId=="0"){
             ...
             //   echo $_POST[$i."nm"];
                ...
                if($p_id!=0){
                    ...
                    $q1 = "DELETE FROM roomreserve ORDER BY roomreserve_no desc limit 1";

                    $r1 = delete($q1);

                    if($r1==1){
                        $q1 = "DELETE FROM reserve ORDER BY reserve_id desc limit 1";

                        $r1 = delete($q1);

                        if($r1==1){
                            $q1 = "DELETE FROM passenger ORDER BY p_id desc limit 1";

                            $r1 = delete($q1);

                            if($r1==1){
                                echo '<script language="javascript">';
                                echo 'alert("There is a passenger with this ID")';
                                echo '</script>';
                            }
                            else{
                                echo $r1;
