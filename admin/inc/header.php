<div class="container-fluid bg-dark text-light p-3 d-flex align-items-center justify-content-between sticky-top">
    ...
    <a href="index.php" class="btn btn-light btn-sm">LOG OUT</a>
</div>
        ...
        <div class="container-fluid flex-lg-column align-items-stretch">
          ...
          <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="adminDropdown">
            <ul class="nav nav-pills flex-column">
                ...
                <li class="nav-item">
                  <a class="nav-link text-white" href="../Checkin.php">Check in</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-white" href="../checkout.php">Check out</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="rooms.php">Rooms</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-white" href="roomsType.php">Room Type</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-white" href="features_facilities.php">Features</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link text-white" href="icomeReport.php">Income Report</a>
              </li>
            </ul>
          </div>
        </div>
