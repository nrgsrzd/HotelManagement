            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h5 class="card-title m-0" style="color: black;">Search</h5>
                      <!--
...
<form method="POST">
                    <button name="r" type="submit" class="btn btn-dark shadow-none btn-sm">
                        Search Rooms
                    </button>
                    <button name="p" type="submit" class="btn btn-dark shadow-none btn-sm">
                        Search Passengers
                    </button>
</form>
                    <!--
