        ...
        <div class="col-lg-12 bg-white shadow p-4 rounded">
           ...
           <!--         <div class="box1" data-aos="fade-up"> -->
                              ...
                              //      echo "11";
                                    while($row = mysqli_fetch_assoc($res))
                                    {
                                     ...
                                     //   echo $row['room_id'];
                                        $data="";
                                        $data.="
                                <div class='card mb-4 border-0 shadow' style='width:930px; margin-left:70px;'>
                   ...
                   <!--     </div>
                    ...
                    <button name="submitb" type="submit" class="btn custom-bg text-white" style="width:45%; margin-left:300px; margin-top:50px;">Submit</button>
