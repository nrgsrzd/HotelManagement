...
<header class="header">
        <div class="container">
            <div class="row justify-content-between">
                ...
                <nav class="nav .open">
                    <ul>
                        <li class="nav-item"><a href="account.php?Id=<?= $_SESSION["IDs"]?>">Account</a></li>
...
<div class="container availability-form">
    <div class="row">
        <div class="col-lg-12 bg-white shadow p-4 rounded">
            <h5 class="mb-4" style="color: black;">Check Booking Availability</h5>
            <form method="POST"><!-- id="reserve-form"> -->
                <div class="row align-items-end">
                    ...
                    <div class="col-lg-2 mb-3">
                        ...
                        <input type="number" name="np" id="np" min="1" max="6" class="form-control shadow-none" value="<?php echo $frm_data['np'] ?>">
                    </div>
                    <div class="col-lg-2 mb-3">
    ...
    if(isset($_POST['submitReserve'])){
        ...
        if($frm_data['roomType']=='all'){
            ...
            for($i =0 ;$i<$mm;$i++){
                ...
                //gettig feature based the sselected room type
                ...
                if($res=="0"){
                    ...
                    while($row = mysqli_fetch_assoc($res))
                    {
                        ...
                        $data.="<div class='card mb-4 border-0 shadow' style='width:930px; margin-left:300px;'>
            ...
            if($res=="0"){
                ...
                while($row = mysqli_fetch_assoc($res))
                {
                    ...
                    $status = "<button onclick=\"toggle_status($row[room_id],1,$r,$in,$out,$price,$frm_data[np],$frm_data[roomType])\" class='btn btn-dark btn-sm shadow-none'>Reserve Now</button>";
                    $data.="<div class='card mb-4 border-0 shadow' style='width:930px; margin-left:300px;'>
                                <div class='row g-0 p-3 align-items-center'>
                                    <div class='col-md-5 mb-lg-0 mb-md-0 mb-3'>
                                        <img src='images1/rooms/$row[img]' class='img-fluid rounded' alt='...'>
...
<script>
    ...
    function toggle_status(id, val, pid, idate, odate, price,n,type)
    {
        ...
        xhr.onload = function(){
            if(this.responseText!=0){
                ...
                window.location = "passengerReserve.php";
        ...
        xhr.send('toggle_status='+id+'&value='+val+'&pid='+pid+'&idate='+idate+'&odate='+odate+'&price='+price+'&n='+n+'&type='+type);
    }
  </script>
